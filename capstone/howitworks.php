		...
		<div class="container">		
			...
			<div class="main col-md-12">
				...
				<div class="row">
					<div class="col-md-8">
						<ul class="list-icons">
						<li><i class="icon-check-1"></i> What is it? Tired of arriving early just parking? Tired of driving around in traffic look for parking?  Want to ensure you have that perfect tailgate spot on game day? Well then, “Reserve It”.  “Reserve It” allows you to reserve the parking space of your choice.  “Reserve It” saves time and eases the trip planning process.</li>
						<li><i class="icon-check-1"></i> Pricing: prices vary based on proximity to the event. Different private lots have different prices.</li>
						<li><i class="icon-check-1"></i> Where can I park? Anywhere in the lot where you reserved a spot.</li>
						<li><i class="icon-check-1"></i> Am I allowed to cancel my reservations? Sorry, we don’t support refund unless the event is cancelled.</li>
						</ul>
					</div>
